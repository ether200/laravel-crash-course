{{-- First we extend the layout we want to use as parent --}}
@extends('layouts.app')

{{-- Then we add the children component/blade in between section('id') endsection --}}
@section('content')
...
<div class="container-grid-4">
    {{-- Prints the current URL we're in --}}
    {{-- {{  print_r(URL('')) }} --}}
    <div>
        {{-- Using URL method to refer to an image --}}
        {{-- instead of URL you can use assets(only works for public directoy) --}}
